...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* ── Hero ── */}
      <section className="pt-14 bg-brand-900 text-white overflow-hidden relative">
        {/* Supergraphic texture overlay */}
        <div className="supergraphic-overlay" />
          ...
          <div className="max-w-2xl">
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-3">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center gap-2 bg-green-500 hover:bg-green-400 text-white font-bold px-7 py-3.5 rounded-xl transition-colors text-base shadow-lg"
              >
