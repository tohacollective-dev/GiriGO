    ...
    <div className="lp-calc">
      ...
      <div className="lp-calc-form">
        <label className="lp-calc-field">
          <span className="lp-calc-k">Dari</span>
          <input
        ...
        <div className="lp-calc-divider" aria-hidden>
          <span className="lp-calc-line"/>
          <span className="lp-calc-arrow">
        ...
        <label className="lp-calc-field">
          <span className="lp-calc-k">Ke</span>
          <input
            className="lp-calc-input"
            list="lp-zones"
            value={dropoff}
        ...
        <label className="lp-calc-field lp-calc-slider-field">
          <div className="lp-calc-km-row">
            <span className="lp-calc-k">Jarak</span>
            <span className="lp-calc-km">
              {km.toFixed(1)} km
              {isAutoMatch && <span className="lp-calc-auto">auto</span>}
            </span>
          </div>
          <input
            type="range"
      ...
      <div className="lp-calc-result">
        <div className="lp-calc-eta">
          <div className="lp-calc-num">{eta}</div>
          <div className="lp-calc-unit">mnt</div>
        </div>
        <div className="lp-calc-sep"/>
        <div className="lp-calc-rp">
          <div className="lp-calc-money">{fmtRp(ongkir)}</div>
          <div className="lp-calc-money-k">estimasi ongkir</div>
        </div>
      </div>

      <a className="lp-calc-btn" href={waLink} target="_blank" rel="noopener noreferrer">
